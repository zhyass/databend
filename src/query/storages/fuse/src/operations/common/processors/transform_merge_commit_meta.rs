...
impl TransformMergeCommitMeta {
    ...
    pub fn merge_commit_meta(
        ...
        assert_eq!(
            l.table_target_id, r.table_target_id,
            "table ident id mismatch"
        );
        CommitMeta {
            ...
            new_segment_locs: l
                ...
                .collect(),
            table_target_id: l.table_target_id,
...
impl AccumulatingTransform for TransformMergeCommitMeta {
    ...
    fn on_finish(&mut self, _output: bool) -> Result<Vec<DataBlock>> {
        ...
        let table_target_id = to_merged[0].table_target_id;
        let merged = to_merged
            .into_iter()
            .fold(CommitMeta::empty(table_target_id), |acc, x| {
