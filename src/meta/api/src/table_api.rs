    ...
    Self: kvapi::KVApi<Error = MetaError>,
{
    ...
    async fn remove_table_copied_file_info(
        ...
        let table_id = req.table_ref_id.table_id;
        let branch_id = req.table_ref_id.branch_id;
        let table_target_id = branch_id.unwrap_or(table_id);
